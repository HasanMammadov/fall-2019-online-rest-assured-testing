...
public class POJOPracticeWithSpartanApp {
    ...
    public void addSpartanTest() {
        ...
        RequestSpecification requestSpecification = given().// burda post, get, put kimi action yoxdu
                // sadece spefication var. ona gore response da yoxdu.
        ...
        // burda ise action var, meselen pot, post request edirikse evezinde response olacaq
        // ve onu response da store edirik
    ...
    public void updateSpartanTest() {
        ...
        //get spartan from web service pojo
        Spartan spartanToUpdate = given().
                auth().basic("admin", "admin").//it return pojo
                accept(ContentType.JSON).
                when().
